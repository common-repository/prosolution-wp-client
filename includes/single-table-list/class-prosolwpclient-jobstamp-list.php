...
<?php
    ...
    class CBXProSolWpClientJobstamp_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpjobstamplist',     //singular name of the listed records
                                    'plural'   => 'pswpjobstamplists',    //plural name of the listed records
        ...
        function column_add_by($item)
        {
            return stripslashes($item['add_by']);
        }
        ...
        {
            return stripslashes($item['add_date']);
        }
        ...
        function proSol_get_columns()
        {
            $columns = array(
                ...
                'add_by'           => esc_html__('Add by', 'prosolwpclient'),
                'add_date'         => esc_html__('Add date', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'add_by'            => array('add_by', false),     //true means it's already sorted
        ...
        function prepare_items()
        {
            ...
            $orderby = (isset($_REQUEST['orderby']) && $_REQUEST['orderby'] != '') ? $_REQUEST['orderby'] : 'add_date';
         ...
         */
        function proSol_getData($search = '', $orderby = 'add_date', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT add_by,add_date,site_id FROM $table_ps_jobstamp";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" add_by LIKE '%%%s%%' OR add_date LIKE '%%%s%%' 
         ...
         * @return array|null|object
         */
        function proSol_getDataCount($search = '', $orderby = 'add_date', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_jobstamp";
