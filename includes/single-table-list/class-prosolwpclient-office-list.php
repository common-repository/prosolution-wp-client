...
<?php
    ...
    class CBXProSolWpClientOffice_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpofficelist',     //singular name of the listed records
                                    'plural'   => 'pswpofficelists',    //plural name of the listed records
        ...
        function column_mandant($item)
        {
            return stripslashes($item['mandant']);
        }
        ...
        {
            return stripslashes($item['name2']);
        }

        /**
         * Callback for collumn 'street'
         *
         * @param array $item
         *
         * @return string
        ...
        {
            return stripslashes($item['street']);
        }
        ...
        function column_zip($item)
        {
            return stripslashes($item['zip']);
        }
        ...
        function column_fax($item)
        {
            return stripslashes($item['fax']);
        }
        ...
        {
            return stripslashes($item['homepage']);
        }
        ...
        function proSol_get_columns()
        {
            ...
            $columns = array(
                'officeId'   => esc_html__('Office Id', 'prosolwpclient'),
                'mandant'    => esc_html__('Client', 'prosolwpclient'),
                'name'       => esc_html__('Name', 'prosolwpclient'),
                'name2'      => esc_html__('Name 2', 'prosolwpclient'),
                'street'     => esc_html__('Street', 'prosolwpclient'),
                'zip'        => esc_html__('Zip', 'prosolwpclient'),
                'city'       => esc_html__('City', 'prosolwpclient'),
                'phone1'     => esc_html__('Phone 1', 'prosolwpclient'),
                'phone2'     => esc_html__('Phone 2', 'prosolwpclient'),
                'fax'        => esc_html__('Fax', 'prosolwpclient'),
                'email'      => esc_html__('Email', 'prosolwpclient'),
                'homepage'   => esc_html__('Homepage', 'prosolwpclient'),
                'customtext' => esc_html__('Customtext', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'officeId'   => array('officeId', false),     //true means it's already sorted
                'mandant'    => array('mandant', false),
                'name'       => array('name', false),
                'name2'      => array('name2', false),
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT officeId,mandant,name,name2,street,zip,city,phone1,phone2,fax,email,homepage,customtext,site_id FROM $table_ps_office";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" officeId LIKE '%%%s%%' OR mandant LIKE '%%%s%%' OR name LIKE '%%%s%%' 
                OR name2 LIKE '%%%s%%' OR street LIKE '%%%s%%' 
                OR zip LIKE '%%%s%%' OR city LIKE '%%%s%%' 
                OR phone1 LIKE '%%%s%%' OR phone2 LIKE '%%%s%%' 
                OR fax LIKE '%%%s%%' OR email LIKE '%%%s%%' 
                OR homepage LIKE '%%%s%%' OR customtext LIKE '%%%s%%'
                OR site_id LIKE '%%%s%%'  
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_office";
