...
<?php
    ...
    class CBXProSolWpClientAvailability_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpavailabilitylist',     //singular name of the listed records
                                    'plural'   => 'pswpavailabilitylists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'availabilityId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_availabilityId($item)
        {
            return stripslashes($item['availabilityId']);
        }
...
//                'cb'          => '<input type="checkbox" />', //Render a checkbox instead of text
                    'availabilityId' => esc_html__('Availability Id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'availabilityId' => array('availabilityId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT availabilityId,name,site_id FROM $table_ps_availability";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" availabilityId LIKE '%%%s%%' OR name LIKE '%%%s%%' OR site_id LIKE '%%%s%%' ", $search, $search, $search);
            }
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_availability";
