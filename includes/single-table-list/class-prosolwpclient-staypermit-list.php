...
<?php
    ...
    class CBXProSolWpClientStaypermit_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpstaypermitlist',     //singular name of the listed records
                                    'plural'   => 'pswpstaypermitlists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'staypermitId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_staypermitId($item)
        {
            return stripslashes($item['staypermitId']);
        }
...
'staypermitId' => esc_html__('Staypermit Id', 'prosolwpclient'),
...
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'staypermitId' => array('staypermitId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT staypermitId,name,site_id FROM $table_ps_staypermit";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" staypermitId LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_staypermit";
