...
<?php
    ...
    class CBXProSolWpClientProfessiongroup_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpprofessiongrouplist',     //singular name of the listed records
                                    'plural'   => 'pswpprofessiongrouplists',    //plural name of the listed records
...
'professiongroupId' => esc_html__('Professiongroup Id', 'prosolwpclient'),
...
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'professiongroupId' => array('professiongroupId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT professiongroupId,name,site_id FROM $table_ps_professiongroup";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" professiongroupId LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_professiongroup";
