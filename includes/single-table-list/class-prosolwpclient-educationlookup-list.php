...
<?php
    ...
    class CBXProSolWpClientEducationlookup_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpeducationlookuplist',     //singular name of the listed records
                                    'plural'   => 'pswpeducationlookuplists',    //plural name of the listed records
        ...
        function column_lookupId($item)
        {
            return stripslashes($item['lookupId']);
        }
        ...
        /**
         * Callback for collumn 'educationId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_educationId($item)
        {
            return stripslashes($item['educationId']);
        }
...
//                'cb'          => '<input type="checkbox" />', //Render a checkbox instead of text
                'lookupId'    => esc_html__('Lookup Id', 'prosolwpclient'),
                'name'        => esc_html__('Name', 'prosolwpclient'),
                'educationId' => esc_html__('Education Id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'lookupId'    => array('lookupId', false),     //true means it's already sorted
                'name'        => array('name', false),
                'educationId' => array('educationId', false),
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT lookupId,name,educationId,site_id FROM $table_ps_educationlookup";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" lookupId LIKE '%%%s%%' OR name LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_educationlookup";
