...
<?php
    ...
    class CBXProSolWpClientSkillgroup_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpskillgrouplist',     //singular name of the listed records
                                    'plural'   => 'pswpskillgrouplists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'skillgroupId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_skillgroupId($item)
        {
            return stripslashes($item['skillgroupId']);
        }
        ...
        /**
         * Callback for collumn 'professiongroups'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_professiongroups($item)
        {
            return stripslashes($item['professiongroups']);
        }
...
'skillgroupId'     => esc_html__('Skillgroup Id', 'prosolwpclient'),
'name'             => esc_html__('Name', 'prosolwpclient'),
'professiongroups' => esc_html__('Profession Groups', 'prosolwpclient'),
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'skillgroupId'     => array('skillgroupId', false),     //true means it's already sorted
                'name'             => array('name', false),
                'professiongroups' => array('professiongroups', false) ,   //true means it's already sorted           
        ...
        function prepare_items()
        {
            ...
            $orderby = (isset($_REQUEST['orderby']) && $_REQUEST['orderby'] != '') ? $_REQUEST['orderby'] : '';
         ...
         */
        function proSol_getData($search = '', $orderby = '', $order = '', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT skillgroupId,name,professiongroups,site_id FROM $table_ps_skillgroup";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" skillgroupId LIKE '%%%s%%' OR name LIKE '%%%s%%' OR professiongroups LIKE '%%%s%%' 
                OR site_id LIKE '%%%s%%' ", $search, $search, $search, $search);
            }
         ...
         * @return array|null|object
         */
        function proSol_getDataCount($search = '', $orderby = '', $order = '')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_skillgroup";
