...
<?php
    ...
    class CBXProSolWpClientQualificationeval_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpqualificationevallist',     //singular name of the listed records
                                    'plural'   => 'pswpqualificationevallists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'qualificationevalId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_qualificationevalId($item)
        {
            return stripslashes($item['qualificationevalId']);
        }
        ...
        function proSol_column_name($item)
        {
...
'qualificationevalId' => esc_html__('Qualificationeval Id', 'prosolwpclient'),
...
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'qualificationevalId' => array('qualificationevalId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT qualificationevalId,name,site_id FROM $table_ps_qualificationeval";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" qualificationevalId LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_qualificationeval";
