...
<?php
    ...
    class CBXProSolWpClientNace_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpnacelist',     //singular name of the listed records
                                    'plural'   => 'pswpnacelists',    //plural name of the listed records
        ...
        function column_naceId($item)
        {
            return stripslashes($item['naceId']);
        }
...
'naceId' => esc_html__('Nace Id', 'prosolwpclient'),
...
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'naceId' => array('naceId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT naceId,name,site_id FROM $table_ps_nace";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" naceId LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_nace";
