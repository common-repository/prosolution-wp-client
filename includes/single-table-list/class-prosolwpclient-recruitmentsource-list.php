...
<?php
    ...
    class CBXProSolWpClientRecruitmentsource_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswprecruitmentsourcelist',     //singular name of the listed records
                                    'plural'   => 'pswprecruitmentsourcelists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'recruitmentsourceId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_recruitmentsourceId($item)
        {
            return stripslashes($item['recruitmentsourceId']);
        }
...
'recruitmentsourceId' => esc_html__('Recruitmentsource Id', 'prosolwpclient'),
...
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'recruitmentsourceId' => array('recruitmentsourceId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT recruitmentsourceId,name,site_id FROM $table_ps_recruitmentsource";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" recruitmentsourceId LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_recruitmentsource";
