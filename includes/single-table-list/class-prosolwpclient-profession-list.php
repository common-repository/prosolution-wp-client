...
<?php
    ...
    class CBXProSolWpClientProfession_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpprofessionlist',     //singular name of the listed records
                                    'plural'   => 'pswpprofessionlists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'professionId'
         *
         * @param array $item
         *
         * @return string
        ...
        /**
         * Callback for collumn 'professiongroupId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_professiongroupId($item)
        {
            return stripslashes($item['professiongroupId']);
        }
...
'professionId' => esc_html__('Profession Id', 'prosolwpclient'),
'name'           => esc_html__('Name', 'prosolwpclient'),
'professiongroupId'           => esc_html__('Profession Group Id', 'prosolwpclient'),
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'professionId' => array('professionId', false),     //true means it's already sorted
                'name'           => array('name', false),
                'professiongroupId'           => array('professiongroupId', false),
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT professionId,name,professiongroupId,site_id FROM $table_ps_profession";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" professionId LIKE '%%%s%%' OR name LIKE '%%%s%%' OR professiongroupId LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_profession";
