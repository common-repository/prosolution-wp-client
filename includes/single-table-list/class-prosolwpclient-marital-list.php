...
<?php
    ...
    class CBXProSolWpClientMarital_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpmaritallist',     //singular name of the listed records
                                    'plural'   => 'pswpmaritallists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'maritalId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_maritalId($item)
        {
            return stripslashes($item['maritalId']);
        }
...
'maritalId' => esc_html__('Marital Id', 'prosolwpclient'),
...
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'maritalId' => array('maritalId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT maritalId,name,site_id FROM $table_ps_marital";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" maritalId LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_marital";
