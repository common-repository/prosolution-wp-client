...
<?php
    ...
    class CBXProSolWpClientSkillrate_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpskillratelist',     //singular name of the listed records
                                    'plural'   => 'pswpskillratelists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'skillrateId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_skillrateId($item)
        {
            return intval($item['skillrateId'])+1;
        }
        ...
        {
            return stripslashes($item['value']);
        }
...
'skillrateId' => esc_html__('Skillrate Id', 'prosolwpclient'),
'name'           => esc_html__('Name', 'prosolwpclient'),
'value'           => esc_html__('Value', 'prosolwpclient'),
'skillgroupId'           => esc_html__('Skill group Id', 'prosolwpclient'),
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'skillrateId' => array('skillrateId', false),     //true means it's already sorted
                'name'           => array('name', false),
                'value'           => array('value', false),
                'skillgroupId'           => array('skillgroupId', false),
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT skillrateId,name,value,skillgroupId,site_id FROM $table_ps_skillrate";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" skillrateId LIKE '%%%s%%' OR name LIKE '%%%s%%' OR value LIKE '%%%s%%' OR skillgroupId LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_skillrate";
