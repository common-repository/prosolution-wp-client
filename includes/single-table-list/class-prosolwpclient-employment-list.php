...
<?php
    ...
    class CBXProSolWpClientEmployment_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpemploymentlist',     //singular name of the listed records
                                    'plural'   => 'pswpemploymentlists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'employmentId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_employmentId($item)
        {
            return stripslashes($item['employmentId']);
        }
...
//                'cb'          => '<input type="checkbox" />', //Render a checkbox instead of text
                'employmentId' => esc_html__('Employment Id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'employmentId' => array('employmentId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT employmentId,name,site_id FROM $table_ps_employment";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" employmentId LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_employment";
