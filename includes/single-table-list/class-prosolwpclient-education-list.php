...
<?php
    ...
    class CBXProSolWpClientEducation_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpeducationlist',     //singular name of the listed records
                                    'plural'   => 'pswpeducationlists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'hasLookup'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_hasLookup($item)
        {
            return stripslashes($item['hasLookup']);
        }
...
//                'cb'          => '<input type="checkbox" />', //Render a checkbox instead of text
                ...
                'hasLookup'   => esc_html__('Has Lookup', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'educationId' => array('educationId', false),     //true means it's already sorted
                'name'        => array('name', false),
                'hasLookup'   => array('hasLookup', false),
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT educationId,name,hasLookup,site_id FROM $table_ps_education";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" educationId LIKE '%%%s%%' OR name LIKE '%%%s%%'  OR hasLookup LIKE '%%%s%%' OR site_id LIKE '%%%s%%'  ", $search, $search, $search, $search	);
            }
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_education";
