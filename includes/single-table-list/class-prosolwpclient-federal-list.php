...
<?php
    ...
    class CBXProSolWpClientFederal_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpfederallist',     //singular name of the listed records
                                    'plural'   => 'pswpfederallists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'federalId'
         *
         * @param array $item
         *
         * @return string
        ...
        /**
         * Callback for collumn 'countryCode'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_countryCode($item)
        {
            return stripslashes($item['countryCode']);
        }
...
'federalId'   => esc_html__('Federal Id', 'prosolwpclient'),
'name'        => esc_html__('Name', 'prosolwpclient'),
'countryCode' => esc_html__('Country Code', 'prosolwpclient'),
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT federalId,name,countryCode,site_id FROM $table_ps_federal";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" federalId LIKE '%%%s%%' OR name LIKE '%%%s%%' OR countryCode LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_federal";
