...
<?php
    ...
    class CBXProSolWpClientContract_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpcontractlist',     //singular name of the listed records
                                    'plural'   => 'pswpcontractlists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'contractId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_contractId($item)
        {
            return stripslashes($item['contractId']);
        }
...
//                'cb'          => '<input type="checkbox" />', //Render a checkbox instead of text
                'contractId' => esc_html__('Contract Id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'contractId' => array('contractId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT contractId,name,site_id FROM $table_ps_contract";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" contractId LIKE '%%%s%%' OR name LIKE '%%%s%%' OR site_id LIKE '%%%s%%' ", $search, $search, $search);
            }
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_contract";
