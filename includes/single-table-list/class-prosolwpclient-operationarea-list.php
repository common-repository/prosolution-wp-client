...
<?php
    ...
    class CBXProSolWpClientOperationarea_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpoperationarealist',     //singular name of the listed records
                                    'plural'   => 'pswpoperationarealists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'operationareaId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_operationareaId($item)
        {
            return stripslashes($item['operationareaId']);
        }
...
'operationareaId' => esc_html__('Operationarea Id', 'prosolwpclient'),
...
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'operationareaId' => array('operationareaId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT operationareaId,name,site_id FROM $table_ps_operationarea";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" operationareaId LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_operationarea";
