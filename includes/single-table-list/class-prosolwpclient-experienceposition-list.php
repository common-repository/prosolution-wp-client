...
<?php
    ...
    class CBXProSolWpClientExperienceposition_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpexperiencepositionlist',     //singular name of the listed records
                                    'plural'   => 'pswpexperiencepositionlists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'experiencepositionId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_experiencepositionId($item)
        {
            return stripslashes($item['experiencepositionId']);
        }
...
//                'cb'          => '<input type="checkbox" />', //Render a checkbox instead of text
                'experiencepositionId' => esc_html__('Experienceposition Id', 'prosolwpclient'),
        ...
        function get_sortable_columns()
        {
            $sortable_columns = array(
                'experiencepositionId' => array('experiencepositionId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT experiencepositionId,name,site_id FROM $table_ps_experienceposition";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" experiencepositionId LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_experienceposition";
