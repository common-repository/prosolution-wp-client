...
<?php
    ...
    class CBXProSolWpClientFilecategoryemp_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpfilecategoryemplist',     //singular name of the listed records
                                    'plural'   => 'pswpfilecategoryemplists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'filecategoryempId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_filecategoryempId($item)
        {
            return stripslashes($item['filecategoryempId']);
        }
...
'filecategoryempId' => esc_html__('Filecategoryemp Id', 'prosolwpclient'),
...
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'filecategoryempId' => array('filecategoryempId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT filecategoryempId,name,site_id FROM $table_ps_filecategoryemp";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" filecategoryempId LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_filecategoryemp";
