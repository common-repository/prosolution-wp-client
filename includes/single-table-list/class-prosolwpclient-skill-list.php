...
<?php
    ...
    class CBXProSolWpClientSkill_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpskilllist',     //singular name of the listed records
                                    'plural'   => 'pswpskilllists',    //plural name of the listed records
        ...
        function column_skillId($item)
        {
            return stripslashes($item['skillId']);
        }
...
'skillId' => esc_html__('Skill Id', 'prosolwpclient'),
...
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'skillId' => array('skillId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT * FROM $table_ps_skill";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" skillId LIKE '%%%s%%' OR name LIKE '%%%s%%' OR skillgroupId LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_skill";
