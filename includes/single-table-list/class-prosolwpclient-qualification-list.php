...
<?php
    ...
    class CBXProSolWpClientQualification_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpqualificationlist',     //singular name of the listed records
                                    'plural'   => 'pswpqualificationlists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'qualificationId'
         *
         * @param array $item
         *
         * @return string
...
'qualificationId' => esc_html__('Qualification Id', 'prosolwpclient'),
...
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'qualificationId' => array('qualificationId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT qualificationId,name,site_id FROM $table_ps_qualification";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" qualificationId LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_qualification";
