...
<?php
    ...
    class CBXProSolWpClientWorkpermit_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpworkpermitlist',     //singular name of the listed records
                                    'plural'   => 'pswpworkpermitlists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'workpermitId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_workpermitId($item)
        {
            return stripslashes($item['workpermitId']);
        }
...
'workpermitId' => esc_html__('Workpermit Id', 'prosolwpclient'),
...
'site_id'           => esc_html__('Site id', 'prosolwpclient')
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'workpermitId' => array('workpermitId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT workpermitId,name,site_id FROM $table_ps_workpermit";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" workpermitId LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_workpermit";
