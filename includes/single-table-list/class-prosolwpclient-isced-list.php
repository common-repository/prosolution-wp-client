...
<?php
    ...
    class CBXProSolWpClientIsced_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpiscedlist',     //singular name of the listed records
                                    'plural'   => 'pswpiscedlists',    //plural name of the listed records
        ...
        function column_iscedId($item)
        {
            return stripslashes($item['iscedId']);
        }
...
'iscedId' => esc_html__('Isced Id', 'prosolwpclient'),
...
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'iscedId' => array('iscedId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT iscedId,name,site_id FROM $table_ps_isced";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" iscedId LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_isced";
