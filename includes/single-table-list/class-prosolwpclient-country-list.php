...
<?php
    ...
    class CBXProSolWpClientCountry_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpcountrylist',     //singular name of the listed records
                                    'plural'   => 'pswpcountrylists',    //plural name of the listed records
...
//                'cb'          => '<input type="checkbox" />', //Render a checkbox instead of text
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'countryCode' => array('countryCode', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT countryCode, name, site_id FROM $table_ps_country";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" countryCode LIKE '%%%s%%' OR name LIKE '%%%s%%' OR site_id LIKE '%%%s%%' ", $search, $search, $search	);
            }
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_country";
