...
<?php
    ...
    class CBXProSolWpClientWorktime_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpworktimelist',     //singular name of the listed records
                                    'plural'   => 'pswpworktimelists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'worktimeId'
         *
         * @param array $item
         *
         * @return string
...
'worktimeId' => esc_html__('worktime Id', 'prosolwpclient'),
...
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'worktimeId' => array('worktimeId', false),     //true means it's already sorted
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT worktimeId,name,site_id FROM $table_ps_worktime";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" worktimeId LIKE '%%%s%%' OR name LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_worktime";
