...
<?php
    ...
    class CBXProSolWpClientJobcustomfields_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpjobcustomfieldslist',     //singular name of the listed records
                                    'plural'   => 'pswpjobcustomfieldslists',    //plural name of the listed records
        ...
        /**
         * Callback for collumn 'customfield_id'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_customfield_id($item)
        {
            return stripslashes($item['customfield_id']);
        }

        /**
         * Callback for collumn 'customfield_name'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_customfield_name($item)
        {
            return stripslashes($item['customfield_name']);
        }
...
//                'cb'          => '<input type="checkbox" />', //Render a checkbox instead of text
                'customfield_id' => esc_html__('Custom fields Id', 'prosolwpclient'),
                'customfield_name'           => esc_html__('Name', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'customfield_id' => array('customfield_id', false),     //true means it's already sorted
                'customfield_name'           => array('customfield_name', false),
        ...
        function prepare_items()
        {
            ...
            $orderby = (isset($_REQUEST['orderby']) && $_REQUEST['orderby'] != '') ? $_REQUEST['orderby'] : 'customfield_name';
         ...
         */
        function proSol_getData($search = '', $orderby = 'customfield_name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT customfield_id,customfield_name,site_id FROM $table_ps_jobcustomfields";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" customfield_id LIKE '%%%s%%' OR customfield_name LIKE '%%%s%%' 
                        OR site_id LIKE '%%%s%%' ", $search, $search, $search, $search, $search	);
            }
         ...
         * @return array|null|object
         */
        function proSol_getDataCount($search = '', $orderby = 'customfield_name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_jobcustomfields";
