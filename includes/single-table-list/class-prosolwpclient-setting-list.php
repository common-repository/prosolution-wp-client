...
<?php
    ...
    class CBXProSolWpClientSetting_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpsettinglist',     //singular name of the listed records
                                    'plural'   => 'pswpsettinglists',    //plural name of the listed records
...
'site_id'           => esc_html__('Site id', 'prosolwpclient'),
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT name,value,site_id FROM $table_ps_setting";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" name LIKE '%%%s%%' OR value LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_setting";
