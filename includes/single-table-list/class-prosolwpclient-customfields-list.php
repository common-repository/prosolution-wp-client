...
<?php
    ...
    class CBXProSolWpClientCustomfields_List_Table extends WP_List_Table
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(array(
                                    'singular' => 'pswpcustomfieldslist',     //singular name of the listed records
                                    'plural'   => 'pswpcustomfieldslists',    //plural name of the listed records
        ...
        function column_customId($item)
        {
            return stripslashes($item['customId']);
        }

        /**
         * Callback for collumn 'customfieldsId'
         *
         * @param array $item
         *
         * @return string
        ...
        function column_customfieldsId($item)
        {
            return stripslashes($item['customfieldsId']);
        }
        ...
        {
            return stripslashes($item['label']);
        }
...
//                'cb'          => '<input type="checkbox" />', //Render a checkbox instead of text
                'customId'       => esc_html__('Custom Id', 'prosolwpclient'),
                'customfieldsId' => esc_html__('Custom fields Id', 'prosolwpclient'),
                'name'           => esc_html__('Name', 'prosolwpclient'),
                'label'          => esc_html__('Label', 'prosolwpclient'),
        ...
        function proSol_get_sortable_columns()
        {
            $sortable_columns = array(
                'customId'       => array('customId', false), 
                'customfieldsId' => array('customfieldsId', false),     //true means it's already sorted
                'name'           => array('name', false),
                'label'          => array('Label', 'prosolwpclient'),
        ...
        function proSol_getData($search = '', $orderby = 'name', $order = 'asc', $perpage = 20, $page = 1)
        {
            ...
            $sql_select = "SELECT customId,customfieldsId,name,label,site_id FROM $table_ps_customfields";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" customId LIKE '%%%s%%' OR customfieldsId LIKE '%%%s%%' OR name LIKE '%%%s%%' OR label LIKE '%%%s%%' 
        ...
        function proSol_getDataCount($search = '', $orderby = 'name', $order = 'asc')
        {
            ...
            $sql_select = "SELECT COUNT(*) FROM $table_ps_customfields";
            ...
            if ($search != '') {
                ...
                $where_sql .= $wpdb->prepare(" customfields LIKE '%%%s%%' OR name LIKE '%%%s%%' 
