...
= 1.9.5 =
* UPDATE: 
  - add new encryption method for API pass

= 1.9.4 =
* UPDATE: 
  - apply job can now be done via WhatsApp URL and WhatsApp QR

= 1.9.3 =
* FIXED Bug: 
  - Added server-side file extension check for fileupload in frontend to Prevent arbitrary file upload
...
= 1.8.13 =
* FIXED Bug: 
  - Job list "workingplace/zipcode" search doesn't work
...
= 1.8.9 =
* Fixed Capital sensitive file extensions during fileupload

= 1.8.8 =
* Job detail page now contain custom field for textfield 21 to 30, add mandatory setting for sidedish document

= 1.8.7 =
* Add new feature, now jobdetail that have new or pending status can be accessed via workexpert recruitment module
