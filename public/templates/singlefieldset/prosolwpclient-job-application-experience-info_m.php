				...
				<div class="exp-form-content">
					...
					<div class="form-group">
						...
						<div class="col-sm-7 error-msg-show">
							<select autocomplete="off" name="experience[0][start]" class="form-control exp-start experience-0-start" id="pswp-exp-beginning-date-0"  data-rule-expstartyearlessorequal="true" onchange="getvalue12(this.value)">
					...
					<div class="form-group">
						...
						<div class="col-sm-7 error-msg-show">
							<select autocomplete="off" name="experience[0][end]" class="form-control exp-end experience-0-end" id="pswp-exp-end-date-0" data-rule-expendyeargraterorequal="true" onchange="getvalue12(this.value)">
	...
	<script type="text/javascript">
		var getvalue12 = function(_this,_cnter=""){
			if(_cnter===''){
				...
				console.log(expGenDesc);
				if(expjob === '' && expEndDt === '' && expBegDt === '' && expDesc === '' && expGenDesc === '' && expCompany === '' && expPostcd === '' && expTown === '' && expCountry === '' && expFeState === '' && expExperiance === '' && expContract === '' && expEmployment === ''){
					console.log("hello");
